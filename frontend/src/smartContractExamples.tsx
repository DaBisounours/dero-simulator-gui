 ...
 */
   ...
   Function Increment(step Uint64) Uint64
     10 STORE("counter", LOAD("counter") + step)
     20 RETURN 0
   End Function`
  },
  {
    name: "Lottery",
    code: `/* Lottery Smart Contract Example in DVM-BASIC.  
    ...
    */
      ...
      Function Initialize() Uint64
      10  IF SIGNER() == address_raw("deto1qyvyeyzrcm2fzf6kyq7egkes2ufgny5xn77y6typhfx9s7w3mvyd5qqynr5hx") THEN GOTO 30 //Exit unless smart contract owner.
      20  RETURN 0 // exit 
      30 version("1.2.3")
